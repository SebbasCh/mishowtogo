...
import 'package:mishowtogo/src/pages/music/edit/music_edit_controller.dart';
...
class MusicEditPage extends StatefulWidget {
  @override
  _MusicEditPageState createState() => _MusicEditPageState();
}

class _MusicEditPageState extends State<MusicEditPage> {

  MusicEditController _con = new MusicEditController();
