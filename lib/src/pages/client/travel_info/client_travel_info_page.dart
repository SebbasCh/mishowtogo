...
import 'package:mishowtogo/src/pages/client/travel_info/client_travel_info_controller.dart';
...
class ClientTravelInfoPage extends StatefulWidget {
  ...
  @override
  _ClientTravelIfoPageState createState() => _ClientTravelIfoPageState();
}

class _ClientTravelIfoPageState extends State<ClientTravelInfoPage> {
      ...
      child: Column(
        children: [
          ...
          ListTile(
            ...
            subtitle: Text(
              '${ _con.minTotal?.toStringAsFixed(2) ?? '0'}\$ - ${_con.maxTotal?.toStringAsFixed(2) ?? '\$ 0'}\$',
              style: TextStyle(
                  fontSize: 13
              ),
              maxLines: 1,
  ...
  Widget _buttonBack() {
    return SafeArea(
      child: Container(
        ...
        child: CircleAvatar(
          radius: 20,
          backgroundColor: utils.Colors.MiShowToGoColor,
