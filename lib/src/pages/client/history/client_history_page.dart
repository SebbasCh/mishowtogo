...
import 'package:mishowtogo/src/pages/client/history/client_history_controller.dart';
import 'package:mishowtogo/src/utils/relative_time_util.dart';
          ...
          return ListView.builder(
            ...
            itemBuilder: (_, index) {
              ...
              return _cardHistoryInfo(
                ...
                snapshot.data[index].nameMusic,
                snapshot.data[index].price?.toString(),
                snapshot.data[index].calificationMusic?.toString(),
